...
class RobotGazeboEnv(gym.Env):
    ...
    def __init__(self, robot_name_space, controllers_list, reset_controls, start_init_physics_parameters=True, reset_world_or_sim="SIMULATION"):
        ...
        #self.gazebo = GazeboConnection(start_init_physics_parameters,reset_world_or_sim)  # gazebo 
        #self.controllers_object = ControllersConnection(namespace=robot_name_space, controllers_list=controllers_list) # gazebo
