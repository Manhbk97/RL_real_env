...
register(
        ...
        entry_point='openai_ros.task_envs.turtlebot2.turtlebot2_position:TurtleBot2PositionEnv',
        timestep_limit=timestep_limit_per_episode,
    )

class TurtleBot2PositionEnv(turtlebot2_env.TurtleBot2Env):
    def __init__(self):
        """
        ...
        super(TurtleBot2PositionEnv, self).__init__()
    ...
    def _get_obs(self):
        ...
        # discretized_observations += odometry_array
