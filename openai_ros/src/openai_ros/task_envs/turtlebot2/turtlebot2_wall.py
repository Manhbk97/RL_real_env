...
class TurtleBot2WallEnv(turtlebot2_env.TurtleBot2Env):
    ...
    def _init_env_variables(self):
        ...
        # Get Desired Point to Get
        #self.allowed_x = list(range(-15, 55))   # irl_test3
        #self.allowed_x = list(range(-10, 87))   # irl_test4
        #self.allowed_x = list(range(-17, 76))   # irl_test5
        #self.allowed_x = list(range(-100, 100))   # irl_test7
        #self.allowed_x = list(range(-5, 99))   # testing_env_2
        #self.allowed_x = list(range(-10, 96))   # testing_env_2_2
        # self.allowed_x = list(range(0, 60))   # real_env
        ...
        #self.allowed_y = list(range(-15, 85))  # irl_test3
        #self.allowed_y = list(range(-55, 100))  # irl_test4
        #self.allowed_y = list(range(-10, 115))  # irl_test5
        #self.allowed_y = list(range(-100, 100))   # irl_test7
        #self.allowed_y = list(range(-5, 109))   # testing_env_2
        #self.allowed_y = list(range(-17, 98))   # testing_env_2_2
        # self.allowed_y = list(range(-18, 18))   # real_env
        ...
        # if -2.0 < self.x_random < 5 and 1.5 < self.y_random < 1.9:
        #     self.x_choose = self.x_random + 0.5
        #     self.y_choose = self.y_random + 0.5
        # elif 4.8 < self.x_random < 5.2 and 1.5 < self.y_random < 6.0:
        #     self.x_choose = self.x_random + 0.5
        #     self.y_choose = self.y_random + 0.5
        # elif -2.0 < self.x_random < 1.0 and 7.4 < self.y_random < 7.7:
        #     self.x_choose = self.x_random + 0.5
        #     self.y_choose = self.x_random + 0.5
        # elif -1.8 < self.x_random < 3.8 and 9.1 < self.y_random < 9.5:
        #     self.x_choose = self.x_random + 0.5
        #     self.y_choose = self.y_random + 0.5
        # else:
        ...
        #     self.y_choose = self.y_random
                ...
                # irl_test4
        # actor_x = [1, 1, 2.475, 0.02, 3.5, 2.0, 5, 4, 3.5, 1.5, 5.5, 3.53, 3.5, 7.5, 7.52, 7.52]
        # actor_y = [-4, -2, -0.5, 3.0, -2.473, 3.0, -2.018, -0.03, 1.52, 1.48, 1.5, 4.5, 8.53, 2.5, 5.5, 8.5]
        # for i in range(len(actor_x)):
        #     if actor_x[i] - 0.3 <= self.x_random <= actor_x[i] + 0.3 and actor_y[i] - 0.3 <= self.y_random <= actor_y[i] + 0.3:
        #         self.x_random = self.x_random + 0.5
        #         self.y_random = self.x_random + 0.5
        #     else:
        #         self.x_random = self.x_random
        #         self.y_random = self.y_random
        ...
        #     self.x_choose = 6.5
        #     self.y_choose = -3.5
        # elif 6.9 < self.x_random < 8 and -4.2 < self.y_random < 0.7:
        #     self.x_choose = 6.5
        #     self.y_choose = -3.5
        ...
        # self.desired_point.x = 5.0    # pedestrian env, (5.5, 7); (3.0, 47.0)
        # self.desired_point.y = -8.0

        self.desired_point.x = 3.5      # testing_env_2_2
        self.desired_point.y = -3.0

        # self.desired_point.x = 4.0      # testing_env_2_2
        # self.desired_point.y = -1.0

        # self.desired_point.x = 7.0      # testing_env_2_2
        # self.desired_point.y = 4.5

        # 
        # print("goal index:" + str(goal))
        # x_point = [2,4,6,8,10]

        # self.x_choose = x_point[goal]
        # goal=goal+1
        
        # self.allowed_x = list(range(20, 50))  
        # self.x_random = (random.choice(self.allowed_x))/10.0
        # self.allowed_y = list(range(-15, 15))  
        # self.y_random = (random.choice(self.allowed_y))/10.0
        # self.x_choose = self.x_random
        # self.y_choose = self.y_random
        ...
        # i = 0
        # goal_x = [1.0, 2.0, 3.0, 4.0]
        # goal_y = [1.0, 2.0, 3.0, 4.0]
        # # i = random.randint(0, 3)
        # i = i+1
        # self.desired_point = Point()
        # self.desired_point.x = float(goal_x[i])
        # self.desired_point.y = float(goal_y[i])
        # self.desired_point.z = 0.0
        # self.show_marker_in_rviz(self.desired_point)
    ...
    def _get_obs(self):
        ...
        print("distance from desired point:" + str(distance_from_des_point))
        ...
        #observations = numpy.concatenate((discretized_laser_scan_norm,relationship_array_norm), axis=0).tolist()
    ...
    def _is_done(self, observations):
        ...
        # elif self.total_path_lenght > 60:
        #     self._episode_done = True
        #     self.move_base(0.0, 0.0, epsilon=0.05, update_rate=10)
        #     rospy.logerr("path too long => " + str(self.total_path_lenght))
        else:
    ...
    def _compute_reward(self, observations, done):
        ...
        if not done:
            ...
            #print('path_lenght: ' + str(path_lenght))
              
        else:
            
            if self.is_in_desired_position(current_position):
                reward = self.end_episode_points
            # elif total_path_lenght > 60:
            #     reward = -*self.end_episode_points 
        ...
        for i, item in enumerate(data.ranges):
            if (i%mod==0):
                ...
                if (self.min_range > item > 0):
                    ...
                    #self._episode_done = True
                    self.move_base(0.0, 0.0, epsilon=0.05, update_rate=5)   #Stop robot
                else:
